                    ...
                    <div class="cardpersonaje">
                        ...
                        <div class="descripcionpersonaje">
                            ...
                            <div class="info-container">
                                ...
                                <p class="personajecaracteristica">Frank Oz</p>
                                <br>
                                <h5 class="perstrong">Especie</h5>
                                <p class="personajecaracteristica">Yoda\'s species</p>
                                <br>
                            </div>
                        </div>
                    </div>
