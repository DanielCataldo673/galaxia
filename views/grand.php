            ...
            <div class="containercard">
                    <div class="cardpersonaje">
                        <div class="imagenpersonaje">
                            <img src="../img/jpg/grand_moff_tarkin.jpg" alt="Grand">
                        </div>
                        <div class="descripcionpersonaje">
                            ...
                            <div class="info-container">
                                ...
                                <p class="personajecaracteristica">Grand Moff Tarkin</p>
                                <br>
                                <h5 class="perstrong">Descripción</h5>
                                <p class="personajecaracteristica">Wilhuff Tarkin, conocido como Gran Moff Tarkin, es un alto funcionario del Imperio Galáctico y comandante del temido Sable de la Muerte, la estación espacial de batalla. Es famoso por su crueldad y su habilidad táctica, desempeñando un papel fundamental en la destrucción de Alderaan. Su determinación y lealtad al Emperador lo convierten en un temible líder militar, conocido por aplicar el vuelo del terror para mantener el control.</p>
                                <br>
                                <h5 class="perstrong">Afiliación</h5>
                                <p class="personajecaracteristica">Imperio Galáctico</p>
                                <br>
                                <h5 class="perstrong">Planeta Natal</h5>
                                <p class="personajecaracteristica">Eriadu</p>
                                <br>
                                <h5 class="perstrong">Habilidades</h5>
                                <p class="personajecaracteristica">Estrategia militar, intimidación.</p>
                                <br>
                                <h5 class="perstrong">Arma</h5>
                                <p class="personajecaracteristica">Poder político.</p>
                                <br>
                                <h5 class="perstrong">Actor</h5>
                                <p class="personajecaracteristica">Peter Cushing</p>
                                <br>
