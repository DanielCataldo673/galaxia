            ...
            <div class="containercard">
                    <div class="cardpersonaje">
                        <div class="imagenpersonaje">
                            <img src="../img/png/obi-wan-kenobi-tv-series.png" alt="Obi-Wan Kenobi">
                        </div>
                        <div class="descripcionpersonaje">
                            ...
                            <div class="info-container">
                                ...
                                <p class="personajecaracteristica">Obi-Wan Kenobi</p>
                                <br>
                                <h5 class="perstrong">Descripción</h5>
                                <p class="personajecaracteristica">Obi-Wan Kenobi es un legendario Maestro Jedi, conocido por su papel en la formación de Anakin Skywalker y posteriormente de su hijo, Luke. Nacido en el planeta Stewjon, Obi-Wan fue un fiel seguidor del Código Jedi, pero también mostró compasión y sabiduría más allá de lo común. Su duelo final con Anakin lo llevó al exilio en Tatooine, donde vigiló a Luke hasta que llegó el momento de entrenarlo en los caminos de la Fuerza.</p>
                                <br>
                                <h5 class="perstrong">Afiliación</h5>
                                <p class="personajecaracteristica">Orden Jedi</p>
                                <br>
                                <h5 class="perstrong">Planeta Natal</h5>
                                <p class="personajecaracteristica">Stewjon</p>
                                <br>
                                <h5 class="perstrong">Habilidades</h5>
                                <p class="personajecaracteristica">Combate con sable de luz</p>
                                <br>
                                <h5 class="perstrong">Arma</h5>
                                <p class="personajecaracteristica">Sable de luz</p>
                                <br>
                                <h5 class="perstrong">Actor</h5>
                                <p class="personajecaracteristica">Ewan McGregor</p>
                                <br>
