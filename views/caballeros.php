  ...
  <div class="grid-contenedor">
    ...
    <div class="articulo5">
      <main>
        ...
        <div class="galeria">
          <div class="foto"><a href="../img/webp/caballeros10.webp" target="_blank"><img class="foto-1"
                src="../img/webp/caballeros10.webp" alt="banderas6"></a>
          </div>

          <div class="foto"><a href="../img/webp/caballeros3.webp" target="_blank"><img class="foto-1"
                src="../img/webp/caballeros3.webp" alt="banderas8"></a>
          </div>

          <div class="foto"><a href="../img/webp/caballeros4.webp" target="_blank"><img class="foto-1"
                src="../img/webp/caballeros4.webp" alt="banderas9"></a>
          </div>
        ...
        <p class="republica">No eran ni Caballeros Jedi ni Lores Sith, sino miembros de una nueva generación de guerreros de la Fuerza que emergió antes de la masacre de los aprendices del Maestro Jedi Luke Skywalker, de los cuales el más prominente era Kylo Ren. Seducido por el poder del lado oscuro, el antiguo Ben Solo renunció a los Jedi y adoptó un nuevo nombre además del título de maestro de los Caballeros de Ren, convirtiéndose en el discípulo del Líder Supremo Snoke y un señor de la guerra de la Primera Orden. Bajo la guía de Snoke, los Caballeros de Ren llenaron el vacío dejado por el fallecimiento del abuelo de Kylo, Darth Vader, el último Lord Sith. Ren, quien se ganó el apodo de «Mata Jedi« al destruir a la generación de Jedi entrenados por Skywalker, estaba determinado a destruir al último Jedi y completar el legado de su abuelo.</p>
        <p class="republica">Durante los últimos días de la Guerra Fría, Ren cazó a su antiguo maestro con el apoyo de las fuerzas de la Primera Orden, viajando a través de la galaxia en busca de pistas de la ubicación del ermitaño Skywalker. Cuando una cadena de eventos se desató, conspirando a forzar una confrontación entre Kylo y su padre, Han Solo, Snoke le advirtió a su aprendiz en constante conflicto que se preparara para su más grande reto hasta ese momento. Aunque aún era vulnerable en el lado luminoso de la Fuerza, el maestro de los Caballeros de Ren estaba confiado de que el entrenamiento del Líder Supremo lo había preparado para tener éxito donde Vader y sus sentimientos fallaron.</p>
        <p class="republica">Poco antes de la caída de la Nueva República, la carroñera de Jakku Rey, visitó el castillo de Maz Kanata en el planeta Takodana, donde la Fuerza la llevó a descubrir el sable de luz Jedi que una vez perteneció a Luke Skywalker y a su padre, Anakin Skywalker, antes de él. Insegura de su conexión con la Fuerza, Rey tocó el sable de luz y consecuentemente experimentó una serie de visiones de la Fuerza, en una de la cual revelaba a Kylo y a los enigmáticos Caballeros de Ren.
        </p>
        <h2>Equipo</h2>
        <p class="republica">Los Caballeros de Ren vestían una armadura abollada y oxidada y escondían sus rostros debajo de máscaras siniestras —haciendo semejanza al casco del mismísimo Kylo. Cada Caballero estaba armado con un arma única y letalmente efectiva, adecuada para combate tanto de corto como de largo alcance.
        </p>

        <div class="galeria">
          <div class="foto"><a href="../img/webp/caballeros8.webp" target="_blank"><img class="foto-1"
                src="../img/webp/caballeros8.webp" alt="banderas6"></a>
          </div>

          <div class="foto"><a href="../img/webp/caballeros9.webp" target="_blank"><img class="foto-1"
                src="../img/webp/caballeros9.webp" alt="banderas8"></a>
          </div>

          <div class="foto"><a href="../img/jpg/caballeros.jpg" target="_blank"><img class="foto-1"
                src="../img/jpg/caballeros.jpg" alt="banderas9"></a>
          </div>

        </div>

        <h2>Descripción</h2>
        <p class="republica">Los Caballeros de Ren no eran ni Jedi ni Sith, sino una nueva generación de guerreros del lado oscuro que emergieron para llenar el vacío dejado por la muerte de los últimos Lores Sith, Darth Sidious y Darth Vader.Tenían una especie de código, el cual eran flexibles en seguirlo: viviendo la vida en la forma en la que querían, tomando lo que la galaxia les diera y consumiendo lo que el lado oscuro les enviara.
        </p>
        <p class="republica">El arquetipo de esta generación era Kylo Ren,el maestro de los Caballeros de Ren y heredero del linaje del más poderoso Jedi o Sith en la historia galáctica.Los Caballeros de Ren servían como los sirvientes más misteriosos y mortales de Kylo.Sensible a la Fuerza como su maestro, los Caballeros eran poderosos en el lado oscuro, aunque no tan poderosos como los Jedi o los Sith.No obstante, sus habilidades de lucha y artes marciales eran incomparables.
        </p>
        <p class="republica">A pesar de las ataduras de Kylo Ren con la Primera Orden, los otros Caballeros no tenían afiliación al sucesor del Imperio Galáctico, ya que Kylo y el Líder Supremo Snoke eran los únicos dos seres que podían comandar la Fuerza en ese Estado ermitaño.[7]
        </p>

        <div class="galeria">
          <div class="foto"><a href="../img/jpg/caballeros2.jpg" target="_blank"><img class="foto-1"
                src="../img/jpg/caballeros2.jpg" alt="banderas6"></a>
          </div>

          <div class="foto"><a href="../img/jpg/caballeros5.jpg" target="_blank"><img class="foto-1"
                src="../img/jpg/caballeros5.jpg" alt="banderas8"></a>
          </div>

          <div class="foto"><a href="../img/jpg/caballeros6.jpg" target="_blank"><img class="foto-1"
                src="../img/jpg/caballeros6.jpg" alt="banderas9"></a>
          </div>
        ...
        <details>
          <summary>
            📜 información de los Caballeros de Ren (haz clic para expandir)
          </summary>
          <table>
            <caption>
            ...
            <thead>
              <tr>
                <th colspan="2">Información de la organización</th>
              </tr>
              <tr>
            ...
            <tbody>
              <tr>
                ...
                <td>Maestro de los Caballeros de Ren</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>Creencias</td>
                <td>Deidades, Lado oscuro de la Fuerza</td>
              </tr>
              <tr>
                <td>Lugares y templos</td>
                <td>Finalizador, Base Starkiller, Supremacía</td>
              </tr>
              <tr>
                <td>Reliquias y artefactos</td>
                <td>Casco de Darth Vader</td>
              </tr>
              <tr class="separator">
              ...
              <tr>
                ...
                <td>Algún tiempo antes de la destrucción del Templo Jedi</td>
              </tr>
            </tbody>
          </table>
        </details>
      </main>
      <div class="iconorepublica"><img src="../img/png/caballeros13-fotor-bg-remover-2024092684411.png" alt="alianzalogo"></div>
    </div>
