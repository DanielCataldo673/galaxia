    ...
    <div class="grid-contenedor">
        ...
        <div class="articulo5">
            <main>
                ...
                <p class="republica2"> Ahsoka Tano es la figura más reconocida con sables de luz amarillos, que son menos comunes que los colores tradicionales de los Jedi y Sith. Este color simboliza un enfoque equilibrado y un papel de protector, no ligado a las normas de la Orden Jedi. Tras separarse de los Jedi, Ahsoka usa estos sables en su búsqueda de justicia y lucha contra el lado oscuro, reflejando su camino individual y deseos morales.
                </p>
                ...
                <div class="galeriasable">
                    ...
                    <div class="fotosable"><a href="../img/sable/sableamarillo.jpg" target="_blank"><img class="fotosable-1"
                                src="../img/sable/sableamarillo.jpg" alt="sable"></a>
                    </div>

                    <div class="fotosable"><a href="../img/sable/amarilla.jpg" target="_blank"><img class="fotosable-1"
                                src="../img/sable/amarilla.jpg" alt="amarilla"></a>
                    </div>
                </div>
