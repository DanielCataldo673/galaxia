            ...
            <div class="containercard">
                    <div class="cardpersonaje">
                        <div class="imagenpersonaje">
                            <img src="../img/webp/AhsokaTano.webp" alt="AhsokaTano">
                        </div>
                        <div class="descripcionpersonaje">
                            ...
                            <div class="info-container">
                                ...
                                <p class="personajecaracteristica">Rosario Dawson</p>
                                <br>
                                <h5 class="perstrong">Especie</h5>
                                <p class="personajecaracteristica">Togruta</p>
                                <br>
                            </div>
                        </div>
                    </div>
