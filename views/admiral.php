            ...
            <div class="containercard">
                    <div class="cardpersonaje">
                        <div class="imagenpersonaje">
                            <img src="../img/jpg/admiral.jpg" alt="Admiral">
                        </div>
                        <div class="descripcionpersonaje">
                            ...
                            <div class="info-container">
                                ...
                                <p class="personajecaracteristica">Admiral Ackbar</p>
                                <br>
                                <h5 class="perstrong">Descripción</h5>
                                <p class="personajecaracteristica">El Almirante Ackbar es un comandante de la Alianza Rebelde, un Mon Calamari conocido por su icónico grito de “¡Es una trampa!” en la batalla de Endor. Su estrategia naval y enfoque táctico lo convierten en una figura de autoridad en la lucha contra el Imperio. Ackbar es un líder carismático y firme que desempeña un papel crucial en los eventos que culminan con la caída del Imperio.</p>
                                <br>
                                <h5 class="perstrong">Afiliación</h5>
                                <p class="personajecaracteristica">Alianza Rebelde</p>
                                <br>
                                <h5 class="perstrong">Planeta Natal</h5>
                                <p class="personajecaracteristica">Mon Cala</p>
                                <br>
                                <h5 class="perstrong">Habilidades</h5>
                                <p class="personajecaracteristica">Estrategia militar, liderazgo.</p>
                                <br>
                                <h5 class="perstrong">Arma</h5>
                                <p class="personajecaracteristica">Pistola bláster</p>
                                <br>
                                <h5 class="perstrong">Actor</h5>
                                <p class="personajecaracteristica">Tim Rose (puppet work)</p>
                                <br>
                                <h5 class="perstrong">Especie</h5>
                                <p class="personajecaracteristica">Mon Calamari</p>
                                <br>
                            </div>
                        </div>
                    </div>
