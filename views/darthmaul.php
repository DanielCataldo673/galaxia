            ...
            <div class="containercard">
                    <div class="cardpersonaje">
                        <div class="imagenpersonaje">
                            <img src="../img/jpg/dark-maul.jpg" alt="Maul">
                        </div>
                        <div class="descripcionpersonaje">
                            ...
                            <div class="info-container">
                                ...
                                <p class="personajecaracteristica">Darth Maul</p>
                                <br>
                                <h5 class="perstrong">Descripción</h5>
                                <p class="personajecaracteristica">Darth Maul fue el primer aprendiz de Darth Sidious y uno de los guerreros Sith más temidos de la galaxia. Con su característico sable de luz doble y su dominio del combate, Maul casi destruyó a la Orden Jedi al asesinar al Maestro Qui-Gon Jinn. Aunque se creyó que había muerto, Maul sobrevivió a su derrota y continuó sembrando el caos en la galaxia, persiguiendo venganza contra Obi-Wan Kenobi y los Jedi.</p>
                                <br>
                                <h5 class="perstrong">Afiliación</h5>
                                <p class="personajecaracteristica">Imperio Galáctico</p>
                                <br>
                                <h5 class="perstrong">Planeta Natal</h5>
                                <p class="personajecaracteristica">Dathomir</p>
                                <br>
                                ...
                                <p class="personajecaracteristica">Ray Park</p>
                                <br>
                                <h5 class="perstrong">Especie</h5>
                                <p class="personajecaracteristica">Zabrak</p>
                                <br>
                            </div>
                        </div>
                    </div>
