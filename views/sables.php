        ...
        <div class="slider">
          ...
          <div id="slider" class="list">
            <div class="item active">
              <img class="myImage" src="../img/sable/sable1.webp" alt="foto1">

            </div>
            <div class="item">
              <img class="myImage" src="../img/sable/sable2.jpg" alt="foto2">

            </div>
            <div class="item">
              <img class="myImage" src="../img/sable/dindjarin.jpg" alt="foto3">

            </div>
            <div class="item">
              <img class="myImage" src="../img/sable/darhtraya.jpg" alt="foto4">

            </div>
            <div class="item">
              <img class="myImage" src="../img/sable/tobias-cornille-dV9ZfzLxaQ4-unsplash.jpg" alt="foto5">

            </div>
            <div class="item">
              <img class="myImage" src="../img/sable/venti-views-35uZM_4wjYg-unsplash.jpg" alt="foto6">

            </div>
            <div class="item">
              <img class="myImage" src="../img/sable/sable7.jpg" alt="foto7">

            </div>
            <div class="item">
              <img class="myImage" src="../img/sable/sable8.jpeg" alt="foto8">

            </div>
            <div class="item">
              <img class="myImage" src="../img/sable/sable9.webp" alt="foto9">

            </div>
            <div class="item">
              <img class="myImage" src="../img/sable/sable10.jpg" alt="foto10">
          ...
          <div class="thumbnail">
            <div>
              <div class="item active">
                <img src="../img/sable/sable1.webp" alt="foto 1">
              </div>
              <div class="content">
            ...
            <div>
              <div class="item">
                <img src="../img/sable/sable2.jpg" alt="foto 2">
              </div>
              <div class="content">
                <button class="fullscreen-btn">FullScreen</button>
              </div>
            ...
            <div>
              <div class="item">
                <img src="../img/sable/dindjarin.jpg" alt="foto 3">
              </div>
              <div class="content">
                <button class="fullscreen-btn">FullScreen</button>
              </div>
            ...
            <div>
              <div class="item">
                <img src="../img/sable/darhtraya.jpg" alt="foto 4">
              </div>
              <div class="content">
                <button class="fullscreen-btn">FullScreen</button>
              </div>
            ...
            <div>
              <div class="item">
                <img src="../img/sable/tobias-cornille-dV9ZfzLxaQ4-unsplash.jpg" alt="foto 5">
              </div>
              <div class="content">
                <button class="fullscreen-btn">FullScreen</button>
              </div>
            ...
            <div>
              <div class="item">
                <img src="../img/sable/venti-views-35uZM_4wjYg-unsplash.jpg" alt="foto 6">
              </div>
              <div class="content">
                <button class="fullscreen-btn">FullScreen</button>
              </div>
            ...
            <div>
              <div class="item">
                <img src="../img/sable/sable7.jpg" alt="foto 7">
              </div>
              <div class="content">
                <button class="fullscreen-btn">FullScreen</button>
              </div>
            ...
            <div>
              <div class="item">
                <img src="../img/sable/sable8.jpeg" alt="foto 8">
              </div>
              <div class="content">
                <button class="fullscreen-btn">FullScreen</button>
              </div>
            ...
            <div>
              <div class="item">
                <img src="../img/sable/sable9.webp" alt="foto 9">
              </div>
              <div class="content">
                <button class="fullscreen-btn">FullScreen</button>
              </div>
            ...
            <div>
              <div class="item">
                <img src="../img/sable/sable10.jpg" alt="foto 10">
              </div>
              <div class="content">
                <button class="fullscreen-btn">FullScreen</button>
              </div>
