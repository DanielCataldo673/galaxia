    ...
    <div class="grid-contenedor">
        ...
        <div class="articulo5">
            <main>
                ...
                <div class="republica3">

                    <h2 class="titulopeli">Rogue One: A Star Wars Story</h2>
                    <br>
                    <img class="imagenpelis" src="../img/peliculas/rogue.webp" alt="epi10">
                    <p class="modals">
                        <br>
                        ...
                        <br>
                        US$1.056 millones a nivel mundial.
                        <br>
                        <br>
                        ...
                        <br>
                        Es la primera película de la saga en ser un spin-off. La actriz Felicity Jones, quien interpreta a Jyn Erso, trabajó con un equipo de creativos para desarrollar su personaje. ¡Primera película sin el logo de Lucasfilm al inicio!
                    </p>
                </div>
