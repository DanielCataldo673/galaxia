            ...
            <div class="containercard">
                    <div class="cardpersonaje">
                        <div class="imagenpersonaje">
                            <img src="../img/jpg/QuiGon.jpg" alt="Qui">
                        </div>
                        <div class="descripcionpersonaje">
                            ...
                            <div class="info-container">
                                ...
                                <p class="personajecaracteristica">Qui-Gon Jinn</p>
                                <br>
                                <h5 class="perstrong">Descripción</h5>
                                <p class="personajecaracteristica">Qui-Gon Jinn fue un Maestro Jedi no ortodoxo, conocido por su enfoque poco convencional hacia la Fuerza y su creencia en las profecías Jedi. Fue el descubridor de Anakin Skywalker, a quien creyó que era el Elegido destinado a traer equilibrio a la Fuerza. Aunque fue asesinado por Darth Maul, su legado vivió a través de su aprendiz, Obi-Wan Kenobi, y el entrenamiento de Anakin, que influiría en el destino de la galaxia.</p>
                                <br>
                                <h5 class="perstrong">Afiliación</h5>
                                <p class="personajecaracteristica">Orden Jedi</p>
                                <br>
                                <h5 class="perstrong">Planeta Natal</h5>
                                <p class="personajecaracteristica">Coruscant</p>
                                <br>
                                ...
                                <p class="personajecaracteristica">Liam Neeson</p>
                                <br>
