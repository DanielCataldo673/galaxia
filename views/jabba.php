            ...
            <div class="containercard">
                    <div class="cardpersonaje">
                        <div class="imagenpersonaje">
                            <img src="../img/jpg/jabba2.jpg" alt="Jabba">
                        </div>
                        <div class="descripcionpersonaje">
                            ...
                            <div class="info-container">
                                ...
                                <p class="personajecaracteristica">Jabba el Hutt</p>
                                <br>
                                <h5 class="perstrong">Descripción</h5>
                                <p class="personajecaracteristica">Jabba el Hutt es un infame gánster del crimen galáctico, conocido por su influyente poder y su repugnante apariencia. Reside en el desierto de Tatooine y controla un vasto imperio criminal, involucrándose en actividades ilegales que van desde el contrabando hasta la esclavitud. Su naturaleza manipuladora y despiadada lo convierte en un formidable adversario. Jabba es un símbolo de la corrupción que alimenta el submundo galáctico.</p>
                                <br>
                                <h5 class="perstrong">Afiliación</h5>
                                <p class="personajecaracteristica">Ninguna (criminal)</p>
                                <br>
                                <h5 class="perstrong">Planeta Natal</h5>
                                <p class="personajecaracteristica">Nal Hutta</p>
                                <br>
                                <h5 class="perstrong">Habilidades</h5>
                                <p class="personajecaracteristica">Manipulación, estrategia criminal, intimidación</p>
                                <br>
                                <h5 class="perstrong">Arma</h5>
                                <p class="personajecaracteristica">Poder político y su propio palacio como fortaleza</p>
                                <br>
                                <h5 class="perstrong">Actor</h5>
                                <p class="personajecaracteristica">Declan Mulholland (como la versión original) y el muñeco</p>
                                <br>
                                <h5 class="perstrong">Especie</h5>
                                <p class="personajecaracteristica">Hutt</p>
                                <br>
                            </div>
                        </div>
                    </div>
