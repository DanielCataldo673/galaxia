...
<head>
  ...
  <!-- Favicon-->
  <link rel="icon" href="../img/ico/logo69-fotor-bg-remover-2024072321659.ico">
...
<body>
  ...
  <div class="grid-contenedor">
    ...
    <div class="articulo4">
      <header>
        <h1>La Primera orden</h1>
      </header>
    </div>
    <div class="articulo5">
      <main>
        <p>La Primera Orden, o también conocida como la Orden, era una facción política y militar gobernada por el Líder Supremo Snoke, pronto asumida por Kylo Ren y aliado con los Caballeros de Ren, que surgió como resultado de la caída del Imperio Galáctico. </p>

        <div class="galeria">
          <div class="foto"><a href="../img/webp/primera.webp" target="_blank"><img class="foto-1"
                src="../img/webp/primera.webp" alt="banderas6"></a>
          </div>

          <div class="foto"><a href="../img/webp/primera2.webp" target="_blank"><img class="foto-1"
                src="../img/webp/primera2.webp" alt="banderas8"></a>
          </div>

          <div class="foto"><a href="../img/webp/primera6.webp" target="_blank"><img class="foto-1"
                src="../img/webp/primera6.webp" alt="banderas9"></a>
          </div>
        ...
        <p class="republica">Después de la Batalla de Jakku, el Imperio se rindió formalmente ante la Nueva República al firmar el Concordato Galáctico, un tratado de paz que marcó el final de la Guerra Civil Galáctica en el 5 DBY. A pesar de su colapso, el legado del Imperio sobrevivió en las Regiones Desconocidas de la galaxia, donde los ex miembros de las Fuerzas Armadas Imperiales tramaron su regreso al poder.</p>
        <p class="republica">En El despertar de la Fuerza, la Primera Orden está comandada por el Líder Supremo Snoke y es combatida por la Resistencia. El aprendiz de Snoke, Kylo Ren, es el maestro de los Caballeros de Ren, un grupo de guerreros de élite que trabajan con la Primera Orden. En la secuela de 2017, Los últimos Jedi, Ren mata a Snoke y se convierte en el nuevo Líder Supremo. En la película de 2019 El ascenso de Skywalker, la Primera Orden se alía con los Sith Eternos, un culto liderado por el Señor Oscuro de los Sith, el Emperador Palpatine, quien se revela que controlaba secretamente la Primera Orden a través de su gobernante títere, Snoke, antes de que este último fuera usurpado por Ren.</p>
        <h2>Descripción</h2>
        <p class="republica">La Primera Orden es una junta militar inspirada por el imperio galáctico. La organización es liderada por una figura que asumió el título de Líder Supremo llamado Snoke. Aproximadamente treinta años después de la batalla de Endor.
        </p>
        <p class="republica">Al igual que su predecesora, la Primera Orden emplea el uso de soldados de asalto, incluyendo variantes como flametroopers y snowtroopers, con este último utilizando snowspeeders de la Primera Orden. También utilizó artillería pesada Stormtroopers y Stormtroopers de control, de los cuales la capitana Phasma era una líder. La</p>
        <p class="republica">Primera Orden también utiliza cazas TIE, así como una variante de las fuerzas especiales y una nueva marca de Destructor Estelar de la que el Finalizer. Su base principal de operaciones era conocido como la Base Starkiller, un planeta de hielo convertido en una base espacial. La base albergaba una superarma capaz de destruir en su totalidad de sistemas estelares completos con solo un disparo. El General Hux estaba al mando de la base.
        </p>
        <p class="republica">Al igual que el viejo Imperio Galáctico, la Primera Orden empleó los servicios de sujetos sensibles a la Fuerza. Líder Supremo Snoke era conocido por ser una figura poderosa en el lado oscuro de la Fuerza, mientras Kylo Ren, quien trabaja bajo sus órdenes, es un miembro de los Caballeros de Ren.
        </p>
        <div class="galeria">
          <div class="foto"><a href="../img/webp/primera7.webp" target="_blank"><img class="foto-1"
                src="../img/webp/primera7.webp" alt="banderas6"></a>
          </div>

          <div class="foto"><a href="../img/webp/primera9.webp" target="_blank"><img class="foto-1"
                src="../img/webp/primera9.webp" alt="banderas8"></a>
          </div>

          <div class="foto"><a href="../img/jpg/primera10.jpg" target="_blank"><img class="foto-1"
                src="../img/jpg/primera10.jpg" alt="banderas9"></a>
          </div>

        </div>

        <h2>Miembros importantes</h2>
        <p class="republica"><strong>Kylo Ren:</strong> Comandante de los Caballeros Ren y de la Primera Orden, su nombre real es Ben Solo, hijo de Han Solo y Leia Organa y antiguo aprendiz y sobrino de Luke Skywalker, que decidió seguir el camino del Lado Oscuro guiado por Snoke, convirtiéndose en su aprendiz (pero no es un sith). Es el enemigo oficial de Rey y Finn. Se convierte en el nuevo Líder Supremo de la Primera Orden, al asesinar a Snoke. Después de redimirse al final, se sacrifica al traspasar su fuerza a Rey, quién destruyo a Palpatine.
          <br>
          <br>
          <strong>Hux:</strong> General de la Primera Orden y de la Base Espacial Starkiller, una de las mayores figuras militares del Imperio. Se reveló que él era el espía de la Resistencia, y es asesinado por el General Pryde.
          <br>
          <br>
          <strong>Snoke: </strong>Líder Supremo de la Primera Orden y de los Caballeros Ren. Fue asesinado y traicionado por su propio aprendiz, Kylo Ren.
          <br>
          <br>
          <strong>Phasma:</strong> Capitana de la Primera Orden, posee una armadura cromada que le distingue del resto de tropas. Fue derrotada a manos de Finn.
        </p>
        <div class="galeria">
          <div class="foto"><a href="../img/jpg/primera3.jpeg" target="_blank"><img class="foto-1"
                src="../img/jpg/primera3.jpeg" alt="banderas6"></a>
          </div>

          <div class="foto"><a href="../img/jpg/primera4.jpg" target="_blank"><img class="foto-1"
                src="../img/jpg/primera4.jpg" alt="banderas8"></a>
          </div>

          <div class="foto"><a href="../img/jpg/primera5.jpg" target="_blank"><img class="foto-1"
                src="../img/jpg/primera5.jpg" alt="banderas9"></a>
          </div>
        ...
        <details>
          <summary>
            📜 información de la Primera orden (haz clic para expandir)
          </summary>
          <table>
            <caption>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Fuerzas Armadas de la Primera Orden</td>
              </tr>
              <tr>
                <td>Capital</td>
                <td>Supremacía; Base Starkiller (extraoficial)</td>
              </tr>
              <tr class="separator">
              ...
              <tr>
                <td>Formado</td>
                <td>Imperio Galáctico, Remanente Imperial</td>
              </tr>
              <tr>
                <td>Fecha de establecimiento</td>
                <td>En algún momento entre el 5 DBY y el 21 DBY</td>
              </tr>
            </tbody>
          </table>
        </details>
    ...
    <div class="articulo6">
      <div class="iconorepublica"><img src="../img/png/logoprimera-fotor-bg-remover-2024092691253.png" alt="alianzalogo"></div>
