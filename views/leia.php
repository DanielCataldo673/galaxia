            ...
            <div class="containercard">
                    <div class="cardpersonaje">
                        <div class="imagenpersonaje">
                            <img src="../img/jpg/leia-star-wars-8-1532775543.jpg" alt="Luke">
                        </div>
                        <div class="descripcionpersonaje">
                            ...
                            <div class="info-container">
                                ...
                                <p class="personajecaracteristica">Leia Organa</p>
                                <br>
                                <h5 class="perstrong">Descripción</h5>
                                <p class="personajecaracteristica">Leia Organa es la princesa de Alderaan y una líder clave en la Alianza Rebelde. Como hija de Anakin Skywalker y hermana gemela de Luke, Leia es también fuerte en la Fuerza, aunque fue entrenada principalmente como diplomática y estratega. Su valentía y determinación fueron cruciales en la lucha contra el Imperio, y posteriormente, en la resistencia contra la Primera Orden. También es conocida por su espíritu indomable y sus habilidades como comandante.</p>
                                <br>
                                <h5 class="perstrong">Afiliación</h5>
                                <p class="personajecaracteristica">Rebel Alliance</p>
                                <br>
                                <h5 class="perstrong">Planeta Natal</h5>
                                <p class="personajecaracteristica">Alderaan</p>
                                <br>
                                <h5 class="perstrong">Habilidades</h5>
                                <p class="personajecaracteristica">Diplomacia</p>
                                <br>
                                <h5 class="perstrong">Arma</h5>
                                <p class="personajecaracteristica">Blaster</p>
                                <br>
                                <h5 class="perstrong">Actor</h5>
                                <p class="personajecaracteristica">Carrie Fisher</p>
                                <br>
